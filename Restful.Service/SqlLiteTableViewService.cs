...
{
    [IocAttribute(ServiceLifetime.Scoped, "Sqlite", typeof(TableViewService))]
    public class SqlLiteTableViewService : TableViewService
    {
        public SqlLiteTableViewService(IServiceProvider serviceProvider) : base(serviceProvider)
        {
